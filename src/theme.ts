...
const colors = {
  ...
  'editor.inactiveSelectionBackground': withOpacity(palette.primary, 0.13),
  'editor.selectionBackground': withOpacity(palette.primary, 0.3),
  'editor.selectionHighlightBackground': withOpacity(palette.string, 0.15),
  'editor.selectionHighlightBorder': transparent,
  'editor.wordHighlightBackground': withOpacity(palette.primary, 0.08),
  'editor.wordHighlightStrongBackground': withOpacity(palette.string, 0.08),
  ...
  'editor.findRangeHighlightBackground': withOpacity(palette.keyword, 0.15),
  'editor.rangeHighlightBackground': withOpacity(palette.keyword, 0.13),
  ...
  'editorIndentGuide.background': withOpacity(palette.comment, 0.2),
  'editorIndentGuide.activeBackground': withOpacity(palette.comment, 0.5),
  ...
  'editorLineNumber.foreground': withOpacity(palette.comment, 0.6),
  'editorLineNumber.activeForeground': withOpacity(palette.comment, 0.9),
  ...
  // Lists
  'list.activeSelectionBackground': withOpacity(palette.primary, 0.15),
  'list.activeSelectionForeground': palette.foregroundBright,
  'list.hoverBackground': withOpacity(palette.primary, 0.08),
  'list.focusBackground': withOpacity(palette.primary, 0.15),
  'list.inactiveSelectionBackground': withOpacity(palette.primary, 0.12),
  ...
  'statusBar.foreground': palette.operator,
  ...
  'menu.selectionBackground': withOpacity(palette.primary, 0.25),
  'menu.selectionForeground': palette.foregroundBright,
  'menu.separatorBackground': palette.border,
  'menubar.selectionBackground': withOpacity(palette.primary, 0.2),

  // Quick Input (Command Palette)
  'quickInput.background': palette.overlay,
  'quickInput.foreground': palette.foreground,
  'quickInputList.focusBackground': withOpacity(palette.primary, 0.25),
  ...
  // Scrollbar
  'scrollbarSlider.background': withOpacity(palette.foregroundDim, 0.2),
  ...
  'breadcrumb.foreground': palette.operator,
  ...
  // Diff Editor
  'diffEditor.insertedLineBackground': withOpacity(palette.added, 0.1),
  'diffEditor.removedLineBackground': withOpacity(palette.deleted, 0.1),
  'diffEditor.insertedTextBackground': withOpacity(palette.added, 0.2),
  'diffEditor.removedTextBackground': withOpacity(palette.deleted, 0.2),
  ...
  'merge.currentContentBackground': withOpacity(palette.added, 0.1),
  'merge.incomingHeaderBackground': withOpacity(palette.primary, 0.3),
  'merge.incomingContentBackground': withOpacity(palette.primary, 0.1),

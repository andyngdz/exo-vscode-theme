 ...
 *
 * Recommended values:
 * - 0.10: High contrast (GitHub-like)
 * - 0.15: Ayu Mirage neutral (default)
 * - 0.18: Softer contrast
 */
export const BACKGROUND_LIGHTNESS = 0.15
...
const MIRAGE_HEX = '#1F2430'

export function mixMirageWithHue(hex: string, ratio: number): string {
  return colord(MIRAGE_HEX)
    .mix(hex, ratio)
    .toHex()
}

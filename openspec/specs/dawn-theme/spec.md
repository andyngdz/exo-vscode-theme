...
A dark VS Code theme inspired by sunrise and early morning light. Provides a muted, eye-friendly coding experience with soft coral accents and warm-tinted backgrounds that evoke the feeling of first light.

## Theme Identity

- **Inspiration**: Morning glow, sunrise, first light
- **Character**: Soft coral accents, warm-tinted backgrounds, rosy morning tones
- **Temperature**: Warm undertones throughout
